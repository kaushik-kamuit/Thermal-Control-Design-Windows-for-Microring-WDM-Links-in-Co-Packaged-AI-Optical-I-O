...
\begin{abstract}
Silicon microring WDM links in co-packaged AI optical I/O need active resonance control. We derive BER-level detuning windows for PAM4 receivers using thermo-optic drift, $Q{=}5200$ rings, Lorentzian leakage, and package stress cases. For 100\,GHz WDM at 25\,dB SNR, lock accuracy is 101--165\,pm.
\end{abstract}
